                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9">
                            <div class="header-banner f-right ">
                                <img src="front/assets/img/gallery/header_card.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<main>
    ...
    <section class="whats-news-area pt-50 pb-20 gray-bg">
        <div class="container">
            <div class="row">
                <div class="col-12"> <!-- Ensures full width -->
                        ...
                        <div class="row justify-content-center mb-15">
                            <div class="col-12"> <!-- Full width column -->
                                <div class="section-tittle mb-30 text-center">
                                    <h3 class="w-100">
                                        Welcome to our Post section! To access our latest Blogs on Lifestyle, Travel, Fashion, Sports, and Technology, please log in.
